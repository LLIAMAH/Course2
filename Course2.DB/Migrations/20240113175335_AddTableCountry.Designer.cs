...
namespace Course2.DB.Migrations
{
    ...
    [Migration("20240113175335_AddTableCountry")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Course2.DB.Entities.Address", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Course2.DB.Entities.Country", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Course2.DB.Entities.Person", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("AddressPerson", b =>
                {
                    b.HasOne("Course2.DB.Entities.Address", null)
                        .WithMany()
                        .HasForeignKey("AddressesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Course2.DB.Entities.Person", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Course2.DB.Entities.Address", b =>
                {
                    b.HasOne("Course2.DB.Entities.Country", "Country")
                        .WithMany("Addresses")
