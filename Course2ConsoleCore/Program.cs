...
////var dateEnd1 = DateTime.Now - dateStart1;
////Console.WriteLine(dateEnd1);
...
////var dateEnd2 = DateTime.Now - dateStart2;
...
////var strin = sb.ToString();
////Console.WriteLine(sb);

//var persons1 = new Person[4];
//var persons = new Person[]
//{
//    new Person() { Name = "V", Surname = "H" }, // a
//    new Person() { Name = "B", Surname = "Y" }, // b
//    new Person() { Name = "A", Surname = "S" }, // c
//};

//persons1[0] = new Person() { Name = "V", Surname = "H" };
//persons1[1] = new Person() { Name = "B", Surname = "Y" };
//persons1[2] = new Person() { Name = "A", Surname = "S" };
//persons1[3] = new Person() { Name = "B", Surname = "H" };

//var searchedPerson2 = persons.First(o => o.Name == "B"); // || null
...
//var personReadonly = personList.AsReadOnly();

//var index = personReadonly.IndexOf(person);

//var list = new List<int>() { 4, 7, 8, 3, 14 };
//list.Add(636);
//Console.WriteLine(list.IndexOf(8));

//var searchedPerson = new Person() { Name = "B", Surname = "Y" }; // d
//var listOfPersons = persons.ToList();
//Console.WriteLine(listOfPersons.IndexOf(searchedPerson));

//var obj1 = new object(); // ВЫДЕЛЯЕМ ПАМЯТЬ и в obj1 - ЗАПИХИВАЕМ АДРЕС начала выделенной памяти #A
//var obj2 = new object(); // ВЫДЕЛЯЕМ ПАМЯТЬ и в obj2 - ЗАПИХИВАЕМ АДРЕС начала выделенной памяти #B

//var result = obj1 == obj2; // ==> obj1.Equals(obj2);
//obj1.Equals(obj2);
...
////Console.WriteLine(personList.Capacity);

////var res = (Person)personList[0];

////var someData = new WorkSet<Person>();
////var someData1 = new WorkSet<int>();
////someData.SetData(persons[0]);
...
////var tt = "sdafsdf..    asd\rf\nas  \r  , \t   df  as\tdf    ";
////var aa = 's'; // это один символ
////var bb = "s"; // это строка 
////var ttt = tt.Split(new[] { '.', ',' }, StringSplitOptions.RemoveEmptyEntries | StringSplitOptions.TrimEntries);
////var a = 10;
...
////sb.Append("sdfasdfasdf");
////sb.Insert(2, "sdfasdfasdfasdf");
...
//////{
//////    Console.WriteLine("Слышь, поцик - а на нуль то делить низзя!!!");
//////}
//////catch (NotImplementedException)
//////{
//////    Console.WriteLine("Слышь, поцик - у тебя метод не имплементирован!");
//////}
//////catch (Exception ex)
//////{
//////    Console.WriteLine("Слышь, поцик - у тебя какая то хрень в коде!!!! " + ex.Message);
//////}
//////finally
//////{
//////    if (File == open)
...
//////using Course2ConsoleCore.Drawing;

//////var object1 = new Auxiliary();
//////object1.ChangeString("SomeString1");
//////var object2 = new Auxiliary();
//////object2.ChangeString("Some String 2");

//////Auxiliary.ChangeStaticString("It is static string which lives forever!");

//////var t = 5;

//////var arrayFigures = new AbstractDrawingObject[20];
//////arrayFigures[0] = new Circle();
//////arrayFigures[1] = new Square();
//////arrayFigures[2] = new CircleColored();
//////...

//////. Set Coordinates

//////((CircleColored) arrayFigures[2]).SetColor(Color.Beige);

//////foreach (var abstractDrawingObject in arrayFigures)
//////{
//////    abstractDrawingObject.Draw();
//////}
...
//////    public static void ChangeStaticString(string s)
//////    {
//////        StaticString = s;
//////    }
...
//////var carYour = new CarGame() { Speed = 200 };
//////var carEnemy = new CarGame() { Speed = 200 };

//////var carCad = new CarCadSystem() { Speed = 200 };

//////using (var initNewObject = new CarCadSystem())
//////{
//////    initNewObject.Body.Metall = "Test";
//////}

//////var interfaced = carYour as ICar;

//////void ChangeAngle(ISetAngle a, int newValue)
//////{
//////    a.SetAngle(newValue);
//////}

//////var carSales = new CarSales();
//////carSales.Speed = 200;
//////var carSales2 = carSales as IHasSpeed;
//////carSales2.Speed = 200;

//////var plane = new Plane();

//////ChangeAngle(plane, 300);
//////ChangeAngle(carYour, 200);

//////if (carYour.Equals(carSales))
//////{
//////    Console.WriteLine("True");
//////}
//////else
...
//////var child2 = new PersonChild2();

//////var list = new Person[2];
//////list[0] = child1;
//////list[1] = child2;

//////var docs = ReadAllDocs();
//////var kasko = (InsuranceKASKO)docs[0];

//////foreach (var insurance in docs)
//////{
//////    Console.WriteLine(insurance.ToString());
//////}

//////var kasko = new InsuranceKASKO("VSAS", "asasdfasdf");

//////var octa = new InsuranceOCTA()
//////{
//////    Owner = "Some person",
//////    CarNumber = "Some car"
//////};
//////List<Insurance> ReadAllDocs()
//////{
//////    return new List<Insurance>()
//////    {
//////        new InsuranceKASKO() { Owner = "VH", KaskoNr = "XXXX", CarNumber = "asdfafe34w3" },
//////        new InsuranceKASKO() { Owner = "VH", KaskoNr = "XXXX", CarNumber = "asdfafe34w3" },
//////        new InsuranceOCTA() { Owner = "VH", CarNumber = "sa32241" },
//////        new InsuranceKASKO() { Owner = "VH", KaskoNr = "XXXX", CarNumber = "asdfafe34w3" },
//////        new InsuranceBuilding() { Owner = "VH", Address = "Some street from Latvia" },
//////        new InsuranceBuilding() { Owner = "VH", Address = "Some street from Latvia" },
//////        new InsuranceOCTA() { Owner = "VH", CarNumber = "sa32241" },
//////        new InsuranceTravel() { Owner = "VH", Country = "USA", Beneficiar = "Sister" },
//////        new InsuranceOCTA() { Owner = "VH", CarNumber = "sa32241" }
//////    };
//////}
...
//////someObject.Input = 3;
//////SomeFunctionWithClass(someObject);
//////Console.WriteLine(someObject.Input); // <==== ? 

//////void SomeFunctionWithClass(SomeClass inputValue)
//////{
//////    inputValue.Input = inputValue.Input + inputValue.Input;
//////}
